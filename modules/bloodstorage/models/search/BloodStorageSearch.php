...
/**
 * BloodStorageSearch represents the model behind the search form about `app\modules\bloodstorage\models\BloodStorage`.
 */
class BloodStorageSearch extends BloodStorage
{
    ...
    {
        return [
            [['id', 'waybill_body_id', 'type_send', 'date_send', 'department', 'defect', 'organization_id', 'recipient_medical_history_id', 'document_number', 'document_date_print', 'partial_transfusion', 'volume_transfused', 'quantity', 'type', 'keytime', 'epicrisis', 'id_cdlc_delete', 'single_wb', 'is_original', 'created_at', 'updated_at', 'status'], 'integer'],
            [['ids', 'recipientkey'], 'safe'],
        ];
    }
